...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0c10]">
      ...
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-[#0b0c10] to-[#1a1b23] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div className="inline-flex items-center px-4 py-2 bg-[#7C3AED]/10 border border-[#7C3AED]/20 rounded-full mb-6">
            <span className="text-[#7C3AED] text-sm font-medium">📞 Contact</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4 p-4 bg-gradient-to-r from-[#563491]/10 to-[#7C3AED]/10 rounded-xl border border-[#7C3AED]/20">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">contact@mshop.com</p>
                  </div>
                </div>
              ...
              <div className="pt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-[#7C3AED]/20 rounded-lg flex items-center justify-center hover:bg-[#7C3AED]/30 transition-colors">
            ...
            {/* Contact Form */}
            <div className="bg-gradient-to-br from-[#1a1b23] to-[#2a2b33] rounded-2xl p-8 border border-[#7C3AED]/20 shadow-2xl">
              ...
              {isSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-300">Merci pour votre message. Nous vous répondrons dans les plus brefs délais.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 bg-[#0b0c10] border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:border-transparent transition-all duration-300"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-3 bg-[#0b0c10] border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:border-transparent transition-all duration-300 resize-none"
