    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <section className="relative py-16 overflow-hidden" style={{ background: 'var(--gradient-primary)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <a
                    href="#how-it-works"
                    className="group border border-[#7C3AED]/30 px-4 py-2 rounded-md font-medium text-sm hover:border-[#7C3AED] hover:bg-[#7C3AED]/5 transition-all duration-300 flex items-center justify-center"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group">
              <div className="bg-transparent rounded-2xl p-6 text-center flex flex-col h-full border-2 border-[#7C3AED]/30 hover:border-[#7C3AED]/60 hover:bg-black/5 dark:hover:bg-[#7C3AED]/5 transition-all duration-300 hover:shadow-xl hover:shadow-[#7C3AED]/20 backdrop-blur-sm">
                ...
                <button className="w-full bg-[#7C3AED] text-white py-2 px-4 rounded-lg font-medium hover:bg-[#6D28D9] transition-all duration-300 hover:shadow-md hover:shadow-[#7C3AED]/25 text-sm">
                  Choisir Basic
                </button>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="bg-transparent rounded-2xl p-6 text-center flex flex-col h-full border-2 border-[#7C3AED] hover:border-[#7C3AED] hover:bg-black/10 dark:hover:bg-[#7C3AED]/10 shadow-xl shadow-[#7C3AED]/10 hover:shadow-[#7C3AED]/25 transition-all duration-300 transform hover:-translate-y-2 backdrop-blur-sm">
                ...
                <button className="w-full bg-white text-[#7C3AED] py-2 px-4 rounded-lg font-medium hover:bg-gray-50 transition-all duration-300 hover:shadow-md hover:shadow-white/25 border border-[#7C3AED]/20 text-sm">
                  Choisir Optimum
                </button>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="bg-transparent rounded-2xl p-6 text-center flex flex-col h-full border-2 border-[#7C3AED]/30 hover:border-[#7C3AED]/60 hover:bg-black/5 dark:hover:bg-[#7C3AED]/5 transition-all duration-300 hover:shadow-xl hover:shadow-[#7C3AED]/20 backdrop-blur-sm">
                ...
                <button className="w-full bg-transparent text-[#7C3AED] py-2 px-4 rounded-lg font-medium hover:bg-[#7C3AED]/10 border-2 border-[#7C3AED] hover:shadow-md hover:shadow-[#7C3AED]/25 text-sm transition-all duration-300">
                  Choisir Premium
                </button>
              </div>
            </div>
